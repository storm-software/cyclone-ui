...
Note that you won't see the social media image in the preview generated for your PR, because it loads from the live `docs.stormsoftware.com` site. You can make sure the image is correct by looking at `[preview-url]/images/open-graph/[page-url].[image-extension]`.

### Custom markdown syntax

The documentation website [docs.stormsoftware.com](https://docs.stormsoftware.com) is using custom Markdown syntax to enable the authors to add functionality to its content.

#### Alert

Alert are available to get the attention of the reader on some specific type of information.

```markdown
{% alert type="info|help|warning|error" title="string" %}
