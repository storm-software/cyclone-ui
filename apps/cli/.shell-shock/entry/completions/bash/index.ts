...
import { showBanner } from "shell-shock:banner/completions/bash";
import { error } from "shell-shock:console";
import { showHelp } from "shell-shock:help/completions/bash";
...
/**
 * The Completions - Bash (powerlines completions bash) virtual command.
 *
 * @remarks
