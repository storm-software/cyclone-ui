...
export const componentsRouter = createRouter({
    list: publicProcedure.query(async ({ ctx }) => {
        ...
        const metaFiles = (await Promise.all(storageList.objects.map(async (storageObject) => {
    ...
    get: publicProcedure
        ...
        const storageFiles = (await Promise.all(storageList.objects.map(async (storageObject) => ctx.storage
