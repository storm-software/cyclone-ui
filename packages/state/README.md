...
A state management package containing various Jotai atoms used by Storm Software
...
```bash
npm install -D @cyclone-ui/state
```
...
Run `nx lint state` to run [ESLint](https://eslint.org/) on the package.
