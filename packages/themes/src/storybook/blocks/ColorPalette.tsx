...
export function ColorPaletteBlock() {
  return (
    ...
    />
      ...
      colors={{
            "base": "var(--color-grey-9)",
            "brand": "var(--color-brand-9)",
            "danger": "var(--color-red-9)",
            "negative": "var(--color-apple-8)",
            "warning": "var(--color-yellow-9)",
            "success": "var(--color-green-9)",
            "positive": "var(--color-avocado-9)",
            "info": "var(--color-sky-9)",
            "discovery": "var(--color-purple-9)",
            "base-hover": "#3d3d3d",
            "base-pressed": "#4d4d4d",
            "base-focused": "#4d4d4d",
            ...
            "base": "var(--color-grey-8)",
            "brand": "var(--color-brand-8)",
            "danger": "var(--color-red-9)",
            "negative": "var(--color-apple-8)",
            "warning": "var(--color-yellow-9)",
            "success": "var(--color-green-9)",
    ...
    />
      ...
      colors={{
            ...
            "base-inverse": "var(--color-black)",
            "brand-inverse": "var(--color-grey-1)",
            "danger-inverse": "var(--color-grey-1)",
            "negative-inverse": "var(--color-grey-1)",
            "warning-inverse": "var(--color-grey-1)",
            "success-inverse": "var(--color-grey-1)",
            "positive-inverse": "var(--color-grey-1)",
            "info-inverse": "var(--color-grey-1)",
            "discovery-inverse": "var(--color-grey-1)",
            "base-hover": "#b6b6b6",
            "base-pressed": "#7b7b7b",
            "base-focused": "#7b7b7b",
            ...
            "info": "var(--color-sky-3)",
            "discovery": "var(--color-purple-7)",
            "base-inverse": "var(--color-grey-9)",
            "brand-inverse": "var(--color-grey-1)",
            "danger-inverse": "var(--color-grey-1)",
            "negative-inverse": "var(--color-grey-1)",
            "warning-inverse": "var(--color-grey-9)",
            "success-inverse": "var(--color-grey-1)",
            "positive-inverse": "var(--color-grey-1)",
            "info-inverse": "var(--color-grey-1)",
            "discovery-inverse": "var(--color-grey-1)",
    ...
    />
      ...
      colors={{
            "grey.emphasis": "var(--color-grey-1)",
            "grey.subtle": "var(--color-grey-9)",
            ...
            "pink.emphasis": "var(--color-pink-5)",
            "pink.subtle": "var(--color-pink-9)",
            "grey.emphasis": "var(--color-grey-5)",
            "grey.subtle": "var(--color-grey-1)",
            "brand.emphasis": "var(--color-brand-1)",
            "brand.subtle": "var(--color-brand-2)",
    ...
    />
      ...
      colors={{
            "body": "var(--color-grey-4)",
            "caption": "var(--color-grey-5)",
            ...
            "body": "var(--color-grey-3)",
            "caption": "var(--color-grey-4)",
            "link": "var(--color-blue-7)",
            "required": "var(--color-apple-5)",
            "body-hover": "#6d6d6d",
            "body-pressed": "#484848",
