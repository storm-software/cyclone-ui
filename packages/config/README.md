...
<br />
This package is part of the <b>⚡Cyclone UI</b> monorepo. The Cyclone UI packages include CLI utility applications, design tokens, design components, and various libraries used to create modern, scalable web applications.
<br />
...
```bash
npm install -D @cyclone-ui/config
```
