...
# package-command-code-block

A package containing the PackageCommandCodeBlock component used by Storm Software

<!-- START doctoc -->
<!-- DON'T EDIT THIS SECTION, INSTEAD RE-RUN doctoc TO UPDATE -->
## Table of Contents

- [package-command-code-block](#package-command-code-block)
...
```bash
pnpm add -D @cyclone-ui/package-command-code-block
```
...
```bash
npm install -D @cyclone-ui/package-command-code-block
```
...
```bash
yarn add -D @cyclone-ui/package-command-code-block
```
...
Run `nx build package-command-code-block` to build the library.

### Running unit tests

Run `nx test package-command-code-block` to execute the unit tests via [Vitest](https://vitest.dev).

### Linting

Run `nx lint package-command-code-block` to run [ESLint](https://eslint.org/) on the package.
