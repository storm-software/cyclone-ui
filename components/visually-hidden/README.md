...
```bash
pnpm add -D @cyclone-ui/visually-hidden
```
...
```bash
npm install -D @cyclone-ui/visually-hidden
```
...
```bash
yarn add -D @cyclone-ui/visually-hidden
```
...
Run `nx build visually-hidden` to build the library.

### Running unit tests

Run `nx test visually-hidden` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint visually-hidden` to run [ESLint](https://eslint.org/) on the package.
