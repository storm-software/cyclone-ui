...
Themeable Gradient component for Cyclone UI

<!-- START doctoc -->
<!-- DON'T EDIT THIS SECTION, INSTEAD RE-RUN doctoc TO UPDATE -->
## Table of Contents

- [Themeable Gradient](#themeable-gradient)
...
```bash
npm install -D @cyclone-ui/input
```
...
Run `nx build input` to build the library.
...
Run `nx lint input` to run [ESLint](https://eslint.org/) on the package.
