...
Phone Number Input Form Field component for Cyclone UI

<!-- START doctoc -->
<!-- DON'T EDIT THIS SECTION, INSTEAD RE-RUN doctoc TO UPDATE -->
## Table of Contents

- [phone-number-input-field](#phone-number-input-field)
...
```bash
pnpm add -D @cyclone-ui/phone-number-input-field
```
...
```bash
npm install -D @cyclone-ui/phone-number-input-field
```
...
```bash
yarn add -D @cyclone-ui/phone-number-input-field
```
...
Run `nx build phone-number-input-field` to build the library.

### Running unit tests

Run `nx test phone-number-input-field` to execute the unit tests via [Vitest](https://vitest.dev).

### Linting

Run `nx lint phone-number-input-field` to run [ESLint](https://eslint.org/) on the package.
