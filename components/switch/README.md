...
A package containing the Switch component used by Storm Software
...
```bash
npm install -D @cyclone-ui/switch
```
...
Run `nx lint switch` to run [ESLint](https://eslint.org/) on the package.
