...
```bash
npm install -D @cyclone-ui/spinner
```
...
Run `nx build spinner` to build the library.

### Running unit tests

Run `nx test spinner` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint spinner` to run [ESLint](https://eslint.org/) on the package.
