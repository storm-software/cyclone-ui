...
```bash
pnpm add -D @cyclone-ui/container
```
...
```bash
npm install -D @cyclone-ui/container
```
...
```bash
yarn add -D @cyclone-ui/container
```
...
Run `nx test config-tools` to execute the unit tests via [Vitest](https://vitest.dev).
