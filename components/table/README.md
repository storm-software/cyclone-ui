...
A package containing the Table component used by Storm Software
...
```bash
npm install -D @cyclone-ui/table
```
...
Run `nx lint table` to run [ESLint](https://eslint.org/) on the package.
